...
const getVisualizerStyle = Object(reselect_lib["createSelector"])(getVisualizationOrder, state => state.visualizerStyle, (visualizationOrder, visualizationStyle) => {
...
// CONCATENATED MODULE: ./js/playlistHtml.js
...
const selectors_getTrackDisplayName = Object(reselect_lib["createSelector"])(getTracks, tracks => {
  return trackId => getTrackDisplayName(tracks, trackId);
});
...
const selectors_getVisualizerStyle = state => getVisualizerStyle(state.display);
...
const applySnap = (original, ...snaps) => snaps.reduce((previous, snapped) => objectSpread_default()({}, previous, {
...
const Hr = () => react_default.a.createElement("li", {
  className: "hr"
...
const MilkdropContextMenu = props => react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(Node, {
  ...
  label: "Desktop Mode",
  hotkey: "Alt+D"
}), react_default.a.createElement(Hr, null), react_default.a.createElement(Node, {
  onClick: props.close,
  label: "Quit"
}));
...
class MilkdropWindow_PresetsLoader extends react_default.a.Component {
  constructor(props) {
    ...
    defineProperty_default()(this, "_toggleDesktop", () => {
  ...
  render() {
    ...
    return react_default.a.createElement(components_GenWindow, {
      ...
      height,
      width
    }) => react_default.a.createElement(ContextMenuWrapper_ContextMenuWraper, {
      onDoubleClick: this._handleRequestFullsceen,
      renderContents: () => react_default.a.createElement(MilkdropWindow_MilkdropContextMenu, {
        close: this.props.closeWindow,
        toggleFullscreen: this._handleRequestFullsceen,
...
async function fetchPreset(presetUrl, {
  isButterchurn
}) {
...
const MilkdropWindow_mapStateToProps = state => ({
  isEnabledVisualizer: selectors_getVisualizerStyle(state) === WINDOWS.MILKDROP,
...
const MilkdropWindow_mapDispatchToProps = dispatch => ({
  ...
  hideWindow: () => dispatch(hideWindow(WINDOWS.MILKDROP)),
  showWindow: () => dispatch(showWindow(WINDOWS.MILKDROP))
});
...
const OptionsContextMenu = props => react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(SkinsContextMenu, null), react_default.a.createElement(Hr, null), react_default.a.createElement(Node, {
  label: "Time elapsed",
...
// CONCATENATED MODULE: ./js/components/MainWindow/MainContextMenu.js
...
const MainContextMenu = props => react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement(LinkNode, {
  ...
  target: "_blank",
  label: "Webamp..."
}), react_default.a.createElement(Hr, null), react_default.a.createElement(Parent, {
  label: "Play"
}, react_default.a.createElement(Node, {
...
}))), react_default.a.createElement(Hr, null), Object.keys(props.genWindows).map(i => react_default.a.createElement(Node, {
  key: i,
...
})), react_default.a.createElement(Hr, null), react_default.a.createElement(SkinsContextMenu, null), react_default.a.createElement(Hr, null), react_default.a.createElement(Parent, {
  label: "Options"
}, react_default.a.createElement(components_OptionsContextMenu, null)), react_default.a.createElement(Parent, {
  label: "Playback"
}, react_default.a.createElement(components_PlaybackContextMenu, null)), react_default.a.createElement(Hr, null), react_default.a.createElement(Node, {
  onClick: props.close,
  label: "Exit"
}));
...
const MainContextMenu_mapDispatchToProps = {
  close: actionCreators_close,
...
class Visualizer_Visualizer extends react_default.a.Component {
  ...
  preRenderBar() {
    this.barCanvas = preRenderBar(this._barWidth(), this._height(), this.props.colors, this._renderHeight());
  }
...
const Close = ({
  onClick
}) => react_default.a.createElement(components_ClickedDiv, {
  id: "close",
  onClick: onClick,
  title: "Close"
});
...
// CONCATENATED MODULE: ./js/components/MainWindow/Shade.js
...
const Shade_mapDispatchToProps = {
  handleClick: toggleMainWindowShadeMode
};
/* harmony default export */ var MainWindow_Shade = (connect_connect(() => ({}), Shade_mapDispatchToProps)(Shade));
...
class MainWindow_MainWindow extends react_default.a.Component {
  ...
  render() {
    ...
    }, react_default.a.createElement(MainWindow_MainContextMenu // @ts-ignore MainContextMenu is not typed yet
    , {
...
const AddMenu = ({
  ...
  addFilesAtIndex,
  addDirAtIndex
}) => react_default.a.createElement(PlaylistMenu_PlaylistMenu, {
...
class PlaylistWindow_PlaylistWindow extends react_default.a.Component {
  ...
  render() {
    ...
    /* TODO: Resize the visualizer so it fits */
     false && false), react_default.a.createElement(PlaylistActionArea, null), react_default.a.createElement(PlaylistWindow_ListMenu, null), react_default.a.createElement("div", {
...
// CONCATENATED MODULE: ./js/components/MediaLibraryWindow/Sidebar.tsx
...
class Sidebar_Sidebar extends react["Component"] {
  render() {
    ...
    }, react["createElement"]("ul", null, react["createElement"]("li", null, "Local Media", react["createElement"]("ul", null, react["createElement"]("li", null, "Audio"), react["createElement"]("li", null, "Video"))), react["createElement"]("li", null, "Playlist"), react["createElement"]("li", null, "Devices", react["createElement"]("ul", null, react["createElement"]("li", null, "CD E:"))), react["createElement"]("li", null, "Internet Radio"), react["createElement"]("li", null, "Internet TV"))), react["createElement"]("button", {
      style: {
        width: "100%",
        marginTop: 1
      }
...
// CONCATENATED MODULE: ./js/components/MediaLibraryWindow/ArtistsTable.tsx

class ArtistsTable_ArtistsTable extends react["Component"] {
  render() {
    return react["createElement"]("div", {
      className: "webamp-media-library-item",
      style: {
    ...
    }, react["createElement"]("thead", null, react["createElement"]("tr", null, react["createElement"]("th", null, "Artist"), react["createElement"]("th", null, "Album"), react["createElement"]("th", null, "Tracks"))), react["createElement"]("tbody", null, react["createElement"]("tr", null, react["createElement"]("td", null, "All (1 artist)"), react["createElement"]("td", null, "1"), react["createElement"]("td", null, "1")), react["createElement"]("tr", null, react["createElement"]("td", null, "Ben Mason"), react["createElement"]("td", null, "1"), react["createElement"]("td", null, "1")))));
  }

}
// CONCATENATED MODULE: ./js/components/MediaLibraryWindow/AlbumsTable.tsx

class AlbumsTable_AlbumsTable extends react["Component"] {
  render() {
    return react["createElement"]("div", {
      className: "webamp-media-library-item",
      style: {
    ...
    }, react["createElement"]("thead", null, react["createElement"]("tr", null, react["createElement"]("th", null, "Album"), react["createElement"]("th", null, "Tracks"))), react["createElement"]("tbody", null, react["createElement"]("tr", null, react["createElement"]("td", null, "All (1 album)"), react["createElement"]("td", null, "1")), react["createElement"]("tr", null, react["createElement"]("td", null, "Ben Mason"), react["createElement"]("td", null, "1")))));
  }
...
// EXTERNAL MODULE: ./js/serializedStates/v1Types.ts
var v1Types = __webpack_require__(201);
